...
const ROWS: ComparisonRow[] = [
  { label: "Entry price", values: ["from $50/mo", "$297/mo (Pro plan)"] },
...
const SECTIONS = [
  ...
  },
  {
    ...
    body: "Hexnut's entry point is $297/mo with no free tier. Missed No More Pro starts at $50/mo with a 7-day free trial, and every plan is a hard cap — no surprise overage charges. If you hit your limit, calls simply forward to your phone instead of racking up a bill.",
  },
  {
...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Missed No More Pro starts at $50/mo with a 7-day free trial; Hexnut's Pro plan is $297/mo with no stated free tier. Both scale up from there — check each vendor's current pricing before you decide, since plans change.",
  },
  {
