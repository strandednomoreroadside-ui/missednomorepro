...
const SECTIONS = [
  {
    ...
    body: "Sameday AI's Pro plan is priced well above our entire range — roughly five to six times our entry price. Missed No More Pro starts at $79/mo with a 7-day free trial, aimed at solo operators and small crews (1–15 people) who want to prove the AI recovers a job before committing to enterprise-scale spend.",
  },
  {
...
const FAQS: FaqItem[] = [
  {
    ...
    a: "For solo operators and small crews, yes — both answer calls for home-service trades, but Missed No More Pro starts at roughly a sixth of Sameday AI's stated Pro price, with a 7-day free trial and a hard usage cap instead of an enterprise-scale commitment.",
  },
  {
