...
const ROWS: ComparisonRow[] = [
  { label: "Entry price", values: ["from $50/mo", "$449/mo (Pro plan)"] },
...
const SECTIONS = [
  {
    ...
    body: "Sameday AI's Pro plan is priced well above our entry price. Missed No More Pro starts at $50/mo with a 7-day free trial, aimed at solo operators and small crews (1-15 people) who want to prove the AI recovers a job before committing to enterprise-scale spend.",
  },
  {
  ...
  },
  {
    ...
    body: "Sameday AI is squarely built for home-service trades and, at its price point, likely includes more done-for-you setup and support than a self-serve $50/mo plan does. We're earlier and smaller — if you need white-glove onboarding and have the budget for it, it's worth a look. We're not able to independently verify every detail of Sameday's current plans as we write this — pricing and features change, so confirm directly with them before deciding.",
  },
];
...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Based on Sameday AI's publicly stated $449/mo Pro plan, yes — Missed No More Pro starts at $50/mo. Confirm current pricing directly with Sameday AI, since plans change.",
  },
  {
