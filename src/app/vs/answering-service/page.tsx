...
const ROWS: ComparisonRow[] = [
  ...
  { label: "Monthly cost", values: ["from $50", "$300+"] },
];
...
const SECTIONS = [
  ...
  },
  {
    ...
    body: "A $300+/mo answering service charges roughly the same whether it books zero jobs or ten. Missed No More Pro starts at $50/mo, and on most plans one recovered job covers the month — because the AI doesn't just take a message, it moves the caller all the way to a booked appointment.",
  },
  {
...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Plans start at $50/mo with a 7-day free trial, and every plan is a hard cap — no surprise overage. If you go over your minutes, calls simply forward to your phone instead of billing you more.",
  },
];
