  ...
  if (bookingEnabled) {
    steps.push(
      'Booking vs. immediate help — decide first: if the caller needs help NOW (stranded, "right away", "as soon as you can", an emergency), do NOT book a future calendar slot. Instead' +
        ...
        ' dispatch the team immediately: call create_contact + notify_staff with urgency "high" or "emergency", and tell them help is on the way as fast as possible and the team will text or call them with an ETA. Do NOT promise a specific arrival time or quote a number of minutes. ' +
